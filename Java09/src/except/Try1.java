...
public class Try1
{
	public static void main(String[] args)
	{
		...
		//0으로 나누기,숫자를 입력하라고 했는데 글자를 입력한다던지 , 0-4를 입력하라 했는데 -1을 입력한다던지
		...
		while(true) {
			...
			int num2 = sc.nextInt();
			//예외처리 : num2가 0일때 나누기 안하는 방법으로 예외처리
//			if(num2 !=0)
//			{
//				mc5.divide(num1, num2); 	//입력받은 숫자 2개를 나누기 해서 결과를 보여줌10
//			}
//			else
//			{
...
//			}		
			...
			{
				//해당 코드에서 예외가 발생했을 경우
				System.out.println("나누기할 때 예외발생");
			}
		}		
	}
}
